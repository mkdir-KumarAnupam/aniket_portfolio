...
const Navbar = ({ darkMode, setDarkMode }) => {
  ...
  useEffect(() => {
    ...
    const svgVariants = [
      ...
      `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="10" viewBox="0 0 310 41" fill="none" preserveAspectRatio="none">
        <path d="M10 30C30 28 45 23 70 25C95 27 95 36 120 33C145 30 140 22 160 20C180 18 185 30 210 28C235 26 240 17 260 15C280 13 290 19 310 22"
        stroke="#000000" stroke-width="10" stroke-linecap="round"/>
      </svg>`,
      `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="10" viewBox="0 0 310 41" fill="none" preserveAspectRatio="none">
        <path d="M5 28C25 34 55 35 85 30C105 27 105 22 135 24C165 26 165 35 195 32C215 30 235 20 260 23C280 25 295 30 310 26"
        stroke="#000000" stroke-width="10" stroke-linecap="round"/>
      </svg>`,
    ];
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between w-full">
        ...
        <div className="hidden md:flex items-center space-x-8 font-sans text-base">
          ...
          <button className="bg-black px-5 py-2 text-white hover:scale-105 hover:shadow-lg font-sans text-base hover:bg-white hover:text-black hover:border hover:border-black transition-all duration-200">
            Contact Me
          </button>
